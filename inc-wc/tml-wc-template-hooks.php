...
**/
add_filter( 'woocommerce_product_single_add_to_cart_text', 'tml_custom_woocommerce_product_single_add_to_cart_text' ); 
add_filter( 'woocommerce_product_add_to_cart_text', 'tml_custom_woocommerce_product_add_to_cart_text' );
