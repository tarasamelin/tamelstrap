...
<form class="pb-3 mb-3 border border-left-0 border-right-0 border-top-0 cart" method="post" enctype='multipart/form-data'>
...
//<td class="align-middle">
				...
				foreach ( $grouped_product_columns as $column_id ) {
					...
					echo '<td class="align-middle woocommerce-grouped-product-list-item__' . esc_attr( $column_id ) . '">' . apply_filters( 'woocommerce_grouped_product_list_column_' . $column_id, $value, $grouped_product ) . '</td>'; // WPCS: XSS ok.
