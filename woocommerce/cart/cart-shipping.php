			...
			<ul class="ml-0 list-group" id="shipping_method">
				<?php foreach ( $available_methods as $method ) : ?>
					<li class="p-1 border-0 list-group-item">
						...
						printf( '<label class="custom-control-label text-secondary" for="shipping_method_%1$s_%2$s">%3$s</label>', $index, esc_attr( sanitize_title( $method->id ) ), wc_cart_totals_shipping_method_label( $method ) ); // WPCS: XSS ok.
