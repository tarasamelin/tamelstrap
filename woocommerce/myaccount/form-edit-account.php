...
<form class="p-1 col-lg-9 woocommerce-EditAccountForm edit-account" action="" method="post">
	...
	<p>
		...
		<button type="submit" class="btn btn-outline-primary woocommerce-Button button" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
