...
<?php endif; ?>
		...
		<form class="col-sm-8 col-md-5 col-lg-3 woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-group form-row">
				...
				<button type="submit" class="btn btn-outline-primary woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="form-group woocommerce-FormRow form-row">
				...
				<button type="submit" class="btn btn-outline-primary woocommerce-Button button" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
			</p>
