...
<form class="form-inline checkout_coupon" method="post" style="display:none">
	...
	<p class="form-group form-row form-row-first">
		<input type="text" name="coupon_code" class="p-1 input-text" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" id="coupon_code" value="" />
	</p>

	<p class="form-group form-row form-row-last">
		<input type="submit" class="ml-3 pt-1 pb-1 btn btn-outline-primary button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>" />
	</p>
