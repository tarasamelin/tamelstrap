...
<form role="search" method="get" class="w-100 py-0 form-inline search-form" action="<?php echo home_url( '/' ); ?>">
    ...
    <button class="border mr-0 bg-white rounded-0 form-control search-submitl" type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button' ) ?>"><i class="text-secondary fas fa-search" aria-hidden="true"></i>
	</button>
</form>